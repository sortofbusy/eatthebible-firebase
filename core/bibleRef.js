...
exports.bibleTranslations = [
	...
	{ language: 'Amharic', name: 'Amharic NT', code: 'amharic'},
    { language: 'Arabic', name: 'Smith and Van Dyke', code: 'arabicsv'},
	{ language: 'Aramaic', name: 'Peshitta NT', code: 'peshitta'},
    { language: 'Armenian', name: '(Genesis Exodus Gospels)', code: 'easternarmenian'},
    { language: 'Armenian', name: 'Western NT', code: 'westernarmenian'},
    { language: 'Basque', name: '(Navarro Labourdin) NT', code: 'basque'},
    { language: 'Breton', name: 'Gospels', code: 'breton'},
    { language: 'Bulgarian', name: 'Bulgarian Bible (1940)', code: 'bulgarian1940'},
    { language: 'Chamorro', name: '(Psalms Gospels Acts)', code: 'chamorro'},
...
exports.chapterNameFromId = function(chapterId) {
	var chaptersRemaining = chapterId;
    for (var i = 0; i < exports.books.length; i++) {
	    var chaptersInNextBook = exports.books[i].chapters.length;
    	if (chaptersRemaining - chaptersInNextBook > 0)
    		chaptersRemaining -= chaptersInNextBook;
    	else {
        	return exports.books[i].name + ' ' + chaptersRemaining;
		}
	}
	return null;
};

exports.chapterIdFromName = function(chapterName) {
	...
	var chapters = 0;
    for (var i = 0; i < exports.books.length; i++) {
	    if (exports.books[i].name === chapterParts[0]) {
